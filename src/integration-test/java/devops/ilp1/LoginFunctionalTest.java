...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        driver.get("http://localhost:6080/One_Click_Travel");
        ...
        pass.sendKeys("1234");
        button.click();
        assertTrue(driver.getPageSource().contains("Welcome to One Click Travel"));
	}
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/One_Click_Travel/register.jsp");
        ...
        button.click();
        assertTrue(driver.getPageSource().contains("One_Click_Travel"));
	}
	
	@Test
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/One_Click_Travel/forgotpassword.jsp");      
